import BasePlugin from '../../handsontable/src/plugins/_base';
import {addClass, removeClass} from '../../handsontable/src/helpers/dom/element';
import {rangeEach} from '../../handsontable/src/helpers/number';
import {arrayEach, arrayFilter} from '../../handsontable/src/helpers/array';
 ...
 *   }
 * });
 * // Access to dxHiddenRows plugin instance:
 * var dxHiddenRowsPlugin = hot.getPlugin('dxHiddenRows');
 *
 * // Show row programmatically:
 * dxHiddenRowsPlugin.showRow(1);
 * // Show rows
 * dxHiddenRowsPlugin.showRow(1, 2, 9);
 * // or
 * dxHiddenRowsPlugin.showRows([1, 2, 9]);
 * hot.render();
 * ...
 * // Hide row programmatically:
 * dxHiddenRowsPlugin.hideRow(1);
 * // Hide rows
 * dxHiddenRowsPlugin.hideRow(1, 2, 9);
 * // or
 * dxHiddenRowsPlugin.hideRows([1, 2, 9]);
 * hot.render();
 * ...
 * ```
 */
class DXHiddenRows extends BasePlugin {
     ...
     */
    isEnabled() {
        return !!this.hot.getSettings().dxHiddenRows;
    }
    ...
    onAfterPluginsInitialized() {
        let settings = this.hot.getSettings().dxHiddenRows;
...
registerPlugin('dxHiddenRows', DXHiddenRows);

export default DXHiddenRows;
